...
public class ArrayListAddInTheMiddle extends AbstractOperation {
    public ArrayListAddInTheMiddle(ViewTag viewTag) {
        super(viewTag);
    }

    @Override
    protected void executeInternal() {
        Utility.arrayList.add(Utility.arrayList.size() / 2, 9999);
    }
}
