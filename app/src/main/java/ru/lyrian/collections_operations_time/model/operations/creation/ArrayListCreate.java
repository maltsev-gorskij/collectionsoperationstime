...
public class ArrayListCreate extends AbstractCreator {
    public ArrayListCreate(ViewTag viewTag, int size) {
        super(viewTag, size);
    }

    @Override
    protected void executeInternal() {
        Utility.getFilledCollection(Collections.ARRAY_LIST, this.size);
    }
}
